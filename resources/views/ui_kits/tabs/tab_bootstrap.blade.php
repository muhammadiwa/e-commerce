    ...
    <div class="container-fluid">
        <div class="row">
                                ...
                                <div class="tab-content" id="v-pills-tabContent">
                                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                        ...
                                        <p class="mb-0">Lorem Ipsum is simply dummy text of the printing and typesetting
                                            ...
                                            PageMaker including versions of Lorem Ipsum. Lorem Ipsum has been the industry's
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card height-equal">
                    <div class="card-header pb-0">
                        <h4>Pill Dark color</h4><span>Add <code>.nav-*</code> class with nav class</span><span>remove
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Primary Color</h4><span>Add <code>.nav-primary</code> class with nav class</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Secondary Color</h4><span>Add <code>.nav-secondary</code> class with nav class</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Success Color</h4><span>Add <code>.nav-success</code> class with nav class</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Info Color</h4><span>Add <code>.nav-info</code> class with nav class</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Warning Color</h4><span>Add <code>.nav-warning</code> class with nav class</span>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-sm-12 col-xl-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Danger Color</h4><span>Add <code>.nav-danger</code> class with nav class</span>
                    </div>
                    <div class="card-body">
