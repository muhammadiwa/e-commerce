    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Large Progress Bars</h4><span>Use <code> .lg-progress-bar</code>class to change progress size to
                            small:</span>
                    </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Basic Progress Bars</h4><span>Progress components are built with two HTML elements, some CSS to
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Small Progress Bars</h4><span>Use <code> .sm-progress-bar</code>class to change progress size to
                            small:</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Custom Height Progress Bars</h4><span>Set a height value on the <code>.progress-bar</code>, so
            ...
            <div class="card">
                    <div class="card-header pb-0">
                        <h4>Multiple bars</h4><span>Include multiple progress bars in a progress component if you
                            need.</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Progress Bars states</h4><span>Use state utility classes to change the appearance of individual
                            progress bars.</span>
                    </div>
                    <div class="card-body progress-showcase">
                        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Progress Bars Striped</h4><span>Add <code>.progress-bar-striped</code> to any
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <h4>Progress Bars animated</h4><span>The striped gradient can also be animated. Add
