                    ...
                    <div class="row">
                      ...
                      <div class="col-7">
                        <div class="text-md-end">
                          <ul>
                            <li>Profit<span class="product-stts txt-primary ms-2">8989<i class="icon-angle-double-up f-12"></i></span></li>
                            <li>Loss<span class="product-stts txt-danger ms-2">2560<i class="icon-angle-double-down f-12"></i></span></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card ecommerce-widget pro-gress">
                  <div class="card-body support-ticket-font">
                    ...
                    <div class="progress-showcase mt-4">
                      <div class="progress">
                        <div class="progress-bar bg-info progress-bar-striped progress-bar-animated" role="progressbar" style="width: 70%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                      </div>
                    </div>
                  </div>
                </div>
