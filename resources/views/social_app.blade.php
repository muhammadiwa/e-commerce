          ...
          <div class="card profile-header"><img class="img-fluid bg-img-cover" src="{{ asset('assets/images/user-profile/bg-profile.jpg') }}" alt="">
            ...
            <div class="userpro-box">
              <div class="img-wrraper">                              
                <div class="avatar"><img class="img-fluid" alt="" src="{{ asset('assets/images/user/7.jpg') }}"></div><a class="icon-wrapper" href="{{ route('edit_profile') }}"><i class="icofont icofont-pencil-alt-5">                              </i></a>
              </div>
                    ...
                    <div class="card">
                      ...
                      <div class="collapse show" id="collapseicon" aria-labelledby="collapseicon" data-parent="#accordion">
                        <div class="card-body socialprofile filter-cards-view">
                          <div class="d-flex align-items-center"><img class="img-50 img-fluid m-r-20 rounded-circle" src="{{ asset('assets/images/user/1.jpg') }}" alt="">
                          ...
                          <div class="customers text-center social-group">
                            <ul>
                              <li class="d-inline-block"><img class="img-30 rounded-circle" src="{{ asset('assets/images/user/3.jpg') }}" alt="" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Johny Waston"></li>
                              <li class="d-inline-block"><img class="img-30 rounded-circle" src="{{ asset('assets/images/user/5.jpg') }}" alt="" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Andew Jon"></li>
                              <li class="d-inline-block"><img class="img-30 rounded-circle" src="{{ asset('assets/images/user/1.jpg') }}" alt="" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Comeren Diaz"></li>
                              <li class="d-inline-block"><img class="img-30 rounded-circle" src="{{ asset('assets/images/user/2.png') }}" alt="" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Bucky Barnes"></li>
                              <li class="d-inline-block"><img class="img-30 rounded-circle" src="{{ asset('assets/images/user/8.jpg') }}" alt="" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Jason Borne"></li>
                              <li class="d-inline-block"><img class="img-30 rounded-circle" src="{{ asset('assets/images/user/11.png') }}" alt="" data-container="body" data-bs-toggle="popover" data-placement="top" title="" data-original-title="Comeren Diaz"></li>
                            </ul>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card">
                      ...
                      <div class="collapse show" id="collapseicon1" data-parent="#accordion" aria-labelledby="collapseicon1">
                        <div class="card-body social-status filter-cards-view">
                          ...
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/2.png') }}" alt="">
                            <div class="social-status social-online"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Bucky Barnes</span></a><span class="d-block">winter@gmail.com</span></div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/10.jpg') }}" alt="">
                            <div class="social-status social-busy"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Sarah Loren</span></a><span class="d-block">barnes@gmail.com</span></div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/6.jpg') }}" alt="">
                            <div class="social-status social-offline"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Jason Borne</span></a><span class="d-block">jasonb@gmail.com</span></div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/8.jpg') }}" alt="">
                            <div class="social-status social-offline"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Comeren Diaz</span></a><span class="d-block">comere@gmail.com</span></div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/14.png') }}" alt="">
                            <div class="social-status social-online"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Andew Jon</span></a><span class="d-block">andrewj@gmail.com</span></div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/4.jpg') }}" alt="">
                            <div class="social-status social-busy"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">John Waston</span></a><span class="d-block">johny@gmail.com</span></div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/3.png') }}" alt="">
                            <div class="social-status social-offline"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Johny William</span></a><span class="d-block">johnyw@gmail.com</span></div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/2.png') }}" alt="">
                            <div class="social-status social-online"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Bucky Barnes</span></a><span class="d-block">winter@gmail.com</span></div>
                          ...
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/4.jpg') }}" alt="">
                            <div class="social-status social-busy"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Johny Waston</span></a><span class="d-block">johny@gmail.com</span></div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/3.png') }}" alt="">
                            <div class="social-status social-offline"></div>
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Johny William</span></a><span class="d-block">johnyw@gmail.com</span></div>
                  ...
                  <div class="col-md-12">
                    <div class="card">
                      ...
                      <div class="collapse show" id="collapseicon12" aria-labelledby="collapseicon12" data-parent="#accordion">
                        <div class="card-body social-status filter-cards-view">
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/10.jpg') }}" alt="">
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Andew Jon</span></a>
                              <p>Commented on Shaun Park's <a href="javascript:void(0)">Photo</a></p><span class="light-span">20 min Ago</span>
                            </div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/3.jpg') }}" alt="">
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Johny Waston</span></a>
                              <p>Commented on Shaun Park's <a href="javascript:void(0)">Photo</a></p><span class="light-span">1 hour Ago</span>
                            </div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/5.jpg') }}" alt="">
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Comeren Diaz</span></a>
                              <p>Commented on Shaun Park's <a href="javascript:void(0)">Photo</a></p><span class="light-span">1 days Ago</span>
                            </div>
                          </div>
                          <div class="d-flex align-items-center"><img class="img-50 rounded-circle m-r-15" src="{{ asset('assets/images/user/4.jpg') }}" alt="">
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="f-w-600 d-block">Sarah Loren</span></a>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="new-users-social">
                        <div class="d-flex align-items-start"><img class="rounded-circle image-radius m-r-15" src="{{ asset('assets/images/user/1.jpg') }}" alt="">
                          <div class="flex-grow-1">
                            <h6 class="mb-0 f-w-700">ELANA</h6>
                            <p>January, 12,2022</p>
                          </div><span class="pull-right mt-0"><i data-feather="more-vertical"></i></span>
                        </div>
                      </div><img class="img-fluid" alt="" src="{{ asset('assets/images/social-app/timeline-1.png') }}">
                      <div class="timeline-content">
                        ...
                        <div class="social-chat">
                          <div class="your-msg">
                            <div class="d-flex align-items-start"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="{{ asset('assets/images/user/1.jpg') }}">
                          ...
                          <div class="other-msg">
                            <div class="d-flex align-items-start"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="{{ asset('assets/images/user/2.png') }}">
                          ...
                          <div class="other-msg">
                            <div class="d-flex align-items-start"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="{{ asset('assets/images/user/3.png') }}">
                        ...
                        <div class="comments-box">
                          <div class="d-flex align-items-center"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="{{ asset('assets/images/user/1.jpg') }}">
                            <div class="flex-grow-1">
                ...
                <div class="col-sm-12">
                  <div class="card">
                    <div class="card-body">
                      ...
                      </div><img class="img-fluid" alt="" src="{{ asset('assets/images/social-app/timeline-2.png') }}">
                      <div class="timeline-content">
                        <p class="mb-0">
                    ...
                    <div class="card">
                      ...
                      <div class="collapse show" id="collapseicon3" aria-labelledby="collapseicon3" data-parent="#accordion">
                        <div class="card-body social-list filter-cards-view">
                          <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="{{ asset('assets/images/user/2.png') }}">
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="d-block">Bucky Barnes</span></a><a href="javascript:void(0)">Add Friend</a></div>
                          </div>
                          <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="{{ asset('assets/images/user/3.png') }}">
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="d-block">Sarah Loren</span></a><a href="javascript:void(0)">Add Friend</a></div>
                          </div>
                          <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="{{ asset('assets/images/user/3.jpg') }}">
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="d-block">Jason Borne</span></a><a href="javascript:void(0)">Add Friend</a></div>
                          </div>
                          <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="{{ asset('assets/images/user/10.jpg') }}">
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="d-block">Comeren Diaz</span></a><a href="javascript:void(0)">Add Friend</a></div>
                          </div>
                          <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="{{ asset('assets/images/user/11.png') }}">
                            <div class="flex-grow-1"><a href="{{ route('user_profile') }}"><span class="d-block">Andew Jon</span></a><a href="javascript:void(0)">Add Friend</a></div>
                          </div>
                        </div>
                      </div>
                    </div>
