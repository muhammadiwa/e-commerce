...
<div class="container-fluid">
    <div class="page-title">
      <div class="row">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('user_profile') }}"><i data-feather="home"></i></a></li>
            ...
            <div class="col-xl-8 xl-60 col-lg-6 col-md-7 box-col-60">
              <div class="card">
                ...
                <div class="collapse" id="collapseicon" aria-labelledby="collapseicon" data-parent="#accordionoc">
                  <div class="card-body">
                    <p class="mb-0">How you approach this process will depend on which web host you use. For example, a lot of hosting providers use cPanel, which includes an option to set up subdomains with just a few clicks.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header">
                  <h5 class="mb-0">
                    <button class="btn btn-link collapsed" data-bs-toggle="collapse" data-bs-target="#collapseicon2" aria-expanded="false" aria-controls="collapseicon2"><i data-feather="help-circle"></i>How do WordPress Site Maintenance ?</button>
                  </h5>
                </div>
                <div class="collapse" id="collapseicon2" data-parent="#accordionoc">
                  <div class="card-body">
                    <p class="mb-0">We’ve just published a detailed on how to backup your WordPress website, however, if you’re in a hurry, here’s a quick solution.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div class="collapse" id="collapseicon3" data-parent="#accordionoc">
                  <div class="card-body">
                    <p class="mb-0">Manually adding meta tags in WordPress is relatively simple. For this demo, we’ll use the example from the WordPress Codex. Imagine you’re Harriet Smith, a veterinarian who blogs about their animal stories on WordPress.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div class="collapse" id="collapseicon4" data-parent="#accordionoc">
                  <div class="card-body">
                    <p class="mb-0">As of version 4.0, you can have WordPress automatically install the language of your choice during the installation process.</p>
                  </div>
                </div>
              </div>
              <div class="faq-title">
              ...
              <div class="card">
                ...
                <div class="collapse" id="collapseicon11" data-parent="#accordionoc">
                  <div class="card-body">
                    <p class="mb-0">Validating a website is the process of ensuring that the pages on the website conform to the norms or standards defined by various organizations.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div class="collapse" id="collapseicon12" data-parent="#accordionoc">
                  <div class="card-body">
                    <p class="mb-0">A book or set of books giving information on many subjects or on many aspects of one subject. Some are intended as an entry point into research for a general audience, some provide detailed information.</p>
                  </div>
                </div>
              </div>
              <div class="faq-title">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="card card-mb-faq xs-mt-search">
                    <div class="card-header faq-header">
                      <h4 class="ps-0">Search articles</h4><i data-feather="help-circle"></i>
                    </div>
                ...
                <div class="col-lg-12">
                  <div class="card card-mb-faq">
                    <div class="card-header faq-header">
                      <h4 class="ps-0">Navigation</h4><i data-feather="settings"></i>
                    </div>
                    <div class="card-body faq-body">
                      ...
                      <div class="navigation-option">
                        <ul>
                          ...
                          <li><a href="javascript:void(0)"><i data-feather="file-text"></i>Articles</a><span class="badge badge-primary rounded-pill pull-right">42</span></li>
                          <li><a href="javascript:void(0)"><i data-feather="youtube"></i>Video Tutorials</a><span class="badge badge-primary rounded-pill pull-right">648</span></li>
                ...
                <div class="col-lg-12">
                  <div class="card">
                    <div class="card-header faq-header">
                      <h4 class="d-inline-block ps-0">Latest Updates</h4><span class="pull-right d-inline-block">See All</span>
                    </div>
                    <div class="card-body faq-body">
          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 box-col-3">
              <div class="card features-faq product-box">
                ...
                <div class="card-footer"><span>Aug 15, 2022</span>
            ...
            <div class="col-xl-3 col-sm-6 box-col-3">
              <div class="card features-faq product-box">
                ...
                <div class="card-footer"><span>June 20, 2022</span>
                  <ul class="rating pull-right">
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
            ...
            <div class="col-xl-3 col-sm-6 box-col-3">
              <div class="card features-faq product-box">
                ...
                <div class="card-footer"><span>July 09, 2022</span>
                  <ul class="rating pull-right">
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
            ...
            <div class="col-xl-3 col-sm-6 box-col-3">
              <div class="card features-faq product-box">
                ...
                <div class="card-footer"><span>July 04, 2022</span>
                  <ul class="rating pull-right">
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
                    <li><i class="fa fa-star font-primary"></i></li>
