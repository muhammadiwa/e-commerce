  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header pb-0">
            <h4>Basic & Edge button group</h4><span>Use<code>.btn-group-pill </code>for edge button.</span>
          </div>
          <div class="card-body btn-group-showcase">
            <div class="row">
              ...
              <div class="col-xl-6 col-md-6 col-sm-12 button-group-mb-sm">
                <div class="btn-group" role="group" aria-label="Basic example">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header pb-0">
            <h4>Flat button group</h4><span>Use <code>.btn-group-square</code>for flat button.</span>
          </div>
          <div class="card-body btn-group-showcase">
            <div class="row">
              <div class="col-xl-6 col-md-6 col-sm-12">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header pb-0">
            <h4>Sizing Button group</h4><span>Use size for different size <code>.btn-lg , .btn-sm</code></span>
          </div>
          <div class="card-body btn-group-showcase">
            <div class="row">
              <div class="col-xl-6 col-sm-12">
                <div class="btn-group" role="group" aria-label="Basic example">
                  <button class="btn btn-primary btn-sm" type="button">Left</button>
              ...
              <div class="col-xl-6 col-sm-12">
                <div class="btn-group" role="group" aria-label="Basic example">
                  <button class="btn btn-success btn-sm" type="button">Left</button>
                  <button class="btn btn-success btn-sm" type="button">Middle</button>
                  <button class="btn btn-success btn-sm" type="button">Right</button>
                </div>
              </div>
              <div class="col-xl-6 col-sm-12">
                <div class="btn-group" role="group" aria-label="Basic example">
                  <button class="btn btn-info btn-sm" type="button">Left</button>
                  <button class="btn btn-info btn-sm" type="button">Middle</button>
                  <button class="btn btn-info btn-sm" type="button">Right</button>
                </div>
              </div>
              <div class="col-xl-6 col-sm-12">
                <div class="btn-group" role="group" aria-label="Basic example">
                  <button class="btn btn-warning btn-sm" type="button">Left</button>
                  <button class="btn btn-warning btn-sm" type="button">Middle</button>
                  <button class="btn btn-warning btn-sm" type="button">Right</button>
                </div>
              </div>
              <div class="col-xl-6 col-sm-12">
                <div class="btn-group" role="group" aria-label="Basic example">
                  ...
                  <button class="btn btn-danger btn-sm" type="button">Right</button>
                </div>
              </div>
              <div class="col-xl-6 col-sm-12">
                <div class="btn-group" role="group" aria-label="Basic example">
                  <button class="btn btn-light btn-sm" type="button">Left</button>
                  <button class="btn btn-light btn-sm" type="button">Middle</button>
                  <button class="btn btn-light btn-sm" type="button">Right</button>
                </div>
              </div>
              <div class="col-xl-6 col-sm-12 button-group-mb-sm">
                <div class="btn-group" role="group" aria-label="Basic example">
                  <button class="btn btn-dark btn-sm" type="button">Left</button>
                  <button class="btn btn-dark btn-sm" type="button">Middle</button>
                  <button class="btn btn-dark btn-sm" type="button">Right</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header pb-0">
            <h4>Radio button group</h4><span>Add <code>.active</code> for active state and<code>.disabled</code> class or <code>disabled="disabled"</code> attribute</span>
          </div>
          <div class="card-body btn-group-showcase">
            <div class="row">
              <div class="col-xl-6 col-md-6 col-sm-12">
      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header pb-0">
            <h4>Check Box button group</h4><span>Add <code>.active</code> for active state and <code>.disabled</code> class or <code>disabled="disabled"</code> attribute</span>
          </div>
          <div class="card-body btn-group-showcase">
            <div class="row">
              ...
              <div class="col-xl-6 col-sm-12 col-md-6 button-group-mb-sm">
                <div class="btn-group btn-option" data-bs-toggle="buttons">
                  <div class="btn btn-light txt-dark">
