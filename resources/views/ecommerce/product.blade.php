                                            ...
                                            <div class="modal-header">
                                                <div class="product-box row">
                                                    ...
                                                    <div class="col-lg-6 text-start">
                                                        <div class="product-details"><a href="{{ route('product_page') }}">
                                                                <h4>Women's Top</h4>
                                                            </a>
                                                            ...
                                                            <div class="product-view">
                                                                ...
                                                                <p class="mb-0">Rock Paper Scissors Women Tank Top High Neck Cotton Top Stylish Women Top..
                                                                </p>
                                                            </div>
                                                            ...
                                                            <div class="product-qnty">
                                                                ...
                                                                <div class="addcart-btn"><a class="btn btn-primary me-3"
                                                                        ...
                                                                        href="{{ route('product_page') }}">View Details</a></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="product-box row">
                                                    ...
                                                    <div class="col-lg-6 text-start">
                                                        <div class="product-details"><a href="{{ route('product_page') }}">
                                                            ...
                                                            <div class="product-view">
                                                                <h6 class="f-w-600">Product Details</h6>
                                                                <p class="mb-0">Lorate Solid Men's Fashion Full Sleeves Latest Jacket for Men With Button Closure Long Sleeve Casual Torn Lycra Denim Jacket.
                                                                </p>
                                                            </div>
                                                            <div class="product-size">
                                                                <ul>
                        ...
                        <div class="card">
                            <div class="product-box">
                                                ...
                                                <div class="product-box row">
                                                    ...
                                                    <div class="col-lg-6 text-start">
                                                        <div class="product-details"><a href="{{ route('product_page') }}">
                                                            ...
                                                            <div class="product-view">
                                                                <h6 class="f-w-600">Product Details</h6>
                                                                <p class="mb-0">Ravaiyaa - Attitude is everything Cotton Women's Dresses One Top Button T-Shirt.
                                                                </p>
                                                            </div>
                                                            <div class="product-size">
                                                                <ul>
                                ...
                                <div class="product-details"><a href="{{ route('product_page') }}">
                                    ...
                                    <p>White Cotton Regular Women's T-shirt</p>
                                    <div class="product-price">$55.00
                                        <del>$85.00</del>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="product-box">
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <div class="product-box row">
                                                    <div class="product-img col-lg-6"><img class="img-fluid"
                                                            src="{{ asset('assets/images/ecommerce/05.jpg') }}" alt=""></div>
                                                    <div class="col-lg-6 text-start">
                                                        <div class="product-details"><a href="{{ route('product_page') }}">
                                ...
                                <div class="product-details"><a href="{{ route('product_page') }}">
                                    ...
                                    <p>Women's Black & White Collection Dress.</p>
                                    <div class="product-price">$45.00
                                        <del>$56.00 </del>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="product-box">
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <div class="product-box row">
                                                    <div class="product-img col-lg-6"><img class="img-fluid"
                                                            src="{{ asset('assets/images/ecommerce/06.jpg') }}" alt=""></div>
                                                    <div class="col-lg-6 text-start">
                                                        <div class="product-details"><a href="{{ route('product_page') }}">
                                                            ...
                                                            <div class="product-view">
                                                                <h6 class="f-w-600">Product Details</h6>
                                                                <p class="mb-0">Lorate Solid women's Fashion red winter Latest collection for women blazer.
                                                                </p>
                                                            </div>
                                                            <div class="product-size">
                                                                <ul>
                                ...
                                <div class="product-details"><a href="{{ route('product_page') }}">
                                    ...
                                    <p>Womens's Red Winter Collection Blazer.</p>
                                    <div class="product-price">$25.00
                                        <del>$45.00 </del>
                                    </div>
                                </div>
                        ...
                        <div class="card">
                            <div class="product-box">
                                ...
                                <div class="product-details"><a href="{{ route('product_page') }}">
                                    ...
                                    <p>Cotton Blend Men's Denim Jacket</p>
                                    <div class="product-price">$38.00
                                        <del>$45.00 </del>
                                    </div>
                                </div>
