        ...
        <div class="row">
                                                ...
                                                <ul
                                                    ...
                                                    <li><a href="javascript:void(0)"><span> Advance</span></a>
                                                        <ul class="hList hList_loose masthead-nav js-languageList">
                                                            <li class="pl-navs-inline"><a
                                                                    href="javascript:void(0)"><span>Scrollable</span></a>
                                                            </li>
                                                            <li class="pl-navs-inline"><a
                                                                    href="javascript:void(0)"><span>Tree View</span></a>
                                                            </li>
                                                            <li class="pl-navs-inline"><a
                                                                    href="javascript:void(0)"><span>Rating</span></a></li>
                                                        </ul>
                                                    </li>
                                                    <li><a href="javascript:void(0)"><span data-mlr-text="">
                                                                Forms</span></a></li>
                                                    <li><a href="javascript:void(0)"><span data-mlr-text="">
                                                                Tables</span></a></li>
                                                </ul>
                                            ...
                                            <div class="masthead" role="banner">
                                                <ul
                                                    ...
                                                    <li><a href="javascript:void(0)"><span> Advance</span></a>
                                                        <ul class="hList hList_loose masthead-nav js-languageList">
                                                            <li class="pl-navs-inline"><a
                                                                    href="javascript:void(0)"><span>Scrollable</span></a><span
                                                                    class="pull-right badge badge-primary">New</span></li>
                                                            <li class="pl-navs-inline"><a
                                                                    href="javascript:void(0)"><span>Tree
                                                                        View</span></a><span
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="language"><span class="font-danger">var </span>LANGUAGES = {<br>"English":
                            {<br>"columns": [<br>"Base",<br>"Advance",<br>"scrollable",<br>"Tree
                            View",<br>"Rating",<br>"News",<br>"Tables",<br>"Base",<br>"Advance",<br>"scrollable",<br>"Tree
                            View",<br>"Rating",<br>"News",<br>"Tables"<br>],<br>"heading": "Static Sub
                            Nav",<br>},<br>"German": {<br>"columns":
                            [<br>"Basis",<br>"Fortschritt",<br>"scrollable",<br>"Baumansicht",<br>"Die
                            Einschaltquote",<br>"Nachrichten",<br>"Tische",<br>"Basis",<br>"Fortschritt",<br>"scrollable",<br>"Baumansicht",<br>"Die
                            Einschaltquote",<br>"Nachrichten",<br>"Tische"<br>],<br>"heading": "Statisches U-Boot
                            Nav",<br>},<br>"Russian": {<br>"columns":
                            [<br>"Основа",<br>"Прогресс",<br>"прокручиваемый",<br>"Представление
                            Дерева",<br>"Оценка",<br>"новости",<br>"Столы",<br>"Основа",<br>"Прогресс",<br>"прокручиваемый",<br>"Представление
                            Дерева",<br>"Оценка",<br>"новости",<br>"Столы"<br>],<br>"heading": "Статический Sub Военно -
                            морской",<br>},<br>"Arabic": {<br>"columns": [<br>"قاعدة",<br>"مقدما",<br>"التمرير",<br>"عرض
                            الشجرة",<br>"تصنيف",<br>"أخبار",<br>"الجداول",<br>"قاعدة",<br>"مقدما",<br>"التمرير",<br>"عرض
                            الشجرة",<br>"تصنيف",<br>"أخبار",<br>"الجداول"<br>],<br>"heading": "صافي قيمة الأصول شبه
                            الثابتة",<br>}<br>};</div>
                    </div>
                </div>
            </div>
