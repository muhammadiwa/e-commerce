                ...
                <div class="blog-single">
                    ...
                    <div class="card comment-box">
                        <div class="card-body">
                            ...
                            <ul>
                                <li>
                                    <div class="d-md-flex align-self-center"><img class="align-self-center"
                                ...
                                <li>
                                    <ul>
                                        <li>
                                            <div class="d-md-flex"><img class="align-self-center"
                                ...
                                <li>
                                    <div class="d-md-flex"><img class="align-self-center" src="{{ asset('assets/images/blog/4.jpg') }}"
                                ...
                                <li>
                                    <div class="d-md-flex"><img class="align-self-center" src="{{ asset('assets/images/blog/12.png') }}"
                                            alt="Generic placeholder image">
                                        <div class="flex-grow-1">
                                            <div class="row">
                                                <div class="col-md-4"><a href="user-profile.html">
                                ...
                                <li>
                                    <div class="d-md-flex"><img class="align-self-center" src="{{ asset('assets/images/blog/14.png') }}"
                                            alt="Generic placeholder image">
                                        <div class="flex-grow-1">
                                            <div class="row">
                                                <div class="col-md-4"><a href="user-profile.html">
                                                        <h6 class="mt-0 text-start">Greg Arias<span> ( Designer )</span>
                                                        </h6>
                                                    </a></div>
                                                <div class="col-md-8">
                                                    <ul class="comment-social">
