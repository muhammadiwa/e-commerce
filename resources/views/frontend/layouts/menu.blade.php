                ...
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus_menu_cat_item show_home toggle_menu">
                        ...
                        @foreach ($categories as $category)
                            <li>
                                <a class="{{ count($category->subCategories) > 0 ? 'wsus__droap_arrow' : ''}}" href="#">{!! $category->icon !!} {{ $category->name }} </a>
                                @if (count($category->subCategories) > 0)
                                <ul class="wsus_menu_cat_droapdown">
                                    @foreach ($category->subCategories as $subCategory)
                                        <li>
                                            <a href="#">{{ $subCategory->name }}
                                                <i class="{{ $subCategory->childCategories->count() > 0 ? 'fas fa-angle-right' : '' }}"></i>
                                            </a>
            ...
            <div class="wsus__mobile_menu_main_menu">
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    <ul class="wsus_mobile_menu_category">
                        ...
                        <li>
                            <a href="#" class="{{ $categoryItem->subCategories->count() > 0 ? 'accordion-button' : '' }} collapsed" data-bs-toggle="collapse"
                                data-bs-target="#flush-collapseThreew-{{$loop->index}}" aria-expanded="false"
                                aria-controls="flush-collapseThreew-{{$loop->index}}">{!! $categoryItem->icon !!} {{ $categoryItem->name }}
                            </a>
