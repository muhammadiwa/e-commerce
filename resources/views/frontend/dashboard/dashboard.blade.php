                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                <img src="{{ asset('back/dist/assets/img/ecommerce/products/13.png') }}"
                                                    alt="Image Description"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                <img src="{{ asset('back/dist/assets/img/ecommerce/products/17.png') }}"
                                                    alt="Image Description"
                                                    class="avatar avatar-xs rounded-sm">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                <img src="{{ asset('back/dist/assets/img/ecommerce/products/14.png') }}"
                                                    alt="Image Description"
                                                    class="avatar avatar-xs rounded-sm">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                <img src="{{ asset('back/dist/assets/img/ecommerce/products/15.png') }}"
                                                    alt="Image Description"
                                                    class="avatar avatar-xs rounded-sm">
                                            </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center">
                                            <div class="ltr:mr-2 rtl:ml-2 leading-none">
                                                <img src="{{ asset('back/dist/assets/img/ecommerce/products/16.png') }}"
                                                    alt="Image Description"
                                                    class="avatar avatar-xs rounded-sm">
                                            </div>
