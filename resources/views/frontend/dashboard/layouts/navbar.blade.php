    ...
    <nav class="main-header" aria-label="Global">
        <div class="header-content">
            ...
            <a class="responsive-logo-dark" href="index.html" aria-label="Brand"><img
                src="{{ asset('back/dist/assets/img/brand-logos/desktop-logo.png') }}" alt="logo" class="mx-auto"></a>
            <a class="responsive-logo-light" href="index.html" aria-label="Brand"><img
                src="{{ asset('back/dist/assets/img/brand-logos/desktop-dark.png') }}" alt="logo" class="mx-auto"></a>
            </div>
            ...
            <div class="responsive-headernav">
                ...
                <div class="header-country hs-dropdown ti-dropdown hidden sm:block"
                    ...
                    <img src="{{ asset('back/dist/assets/img/flags/10.png') }}" alt="flag-img" class="h-[1.375rem] w-[1.375rem]">
                    </button>
                    ...
                    <div class="ti-dropdown-divider divide-y divide-gray-200">
                        ...
                        <div class="ti-dropdown-item">
                            ...
                            <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src="{{ asset('back/dist/assets/img/flags/10.png') }}" alt="flag-img">
                            </div>
                            <div>
                        ...
                        <div class="ti-dropdown-item">
                            <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                            <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src="{{ asset('back/dist/assets/img/flags/1.png') }}" alt="flag-img">
                            </div>
                            <div>
                                <p class="text-xs font-medium">
                                Argentina
                        ...
                        <div class="ti-dropdown-item">
                            <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                            <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src="{{ asset('back/dist/assets/img/flags/2.png') }}" alt="flag-img">
                            </div>
                            <div>
                                <p class="text-xs font-medium">
                                Canada
                        ...
                        <div class="ti-dropdown-item">
                            <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                            <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src="{{ asset('back/dist/assets/img/flags/3.png') }}" alt="flag-img">
                            </div>
                            <div>
                                <p class="text-xs font-medium">
                                France
                        ...
                        <div class="ti-dropdown-item">
                            <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                            <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src="{{ asset('back/dist/assets/img/flags/4.png') }}" alt="flag-img">
                            </div>
                            <div>
                                <p class="text-xs font-medium">
                                Germany
                        ...
                        <div class="ti-dropdown-item">
                            <div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
                            <div class="h-[1.375rem] w-[1.375rem] rounded-sm">
                                <img src="{{ asset('back/dist/assets/img/flags/5.png') }}" alt="flag-img">
                            </div>
                            <div>
                                <p class="text-xs font-medium">
                                Italy
                ...
                <div class="header-cart hs-dropdown ti-dropdown hidden lg:block" data-hs-dropdown-placement="bottom-right">
                    ...
                    <div class="ti-dropdown-divider divide-y divide-gray-200">
                        ...
                        <div class="ti-dropdown-item relative header-box">
                            ...
                            <img loading="lazy" src="{{ asset('back/dist/assets/img/ecommerce/products/1.png') }}" alt="product-img"
                        ...
                        <div class="ti-dropdown-item relative header-box">
                            <a href="cart.html" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <img loading="lazy" src="{{ asset('back/dist/assets/img/ecommerce/products/2.png') }}" alt="product-img"
                                class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 !ring-transparent">
                            <div>
                                <p class="text-sm font-medium text-gray-800">
                                Tshirt For Men
                        ...
                        <div class="ti-dropdown-item relative header-box">
                            <a href="cart.html" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <img loading="lazy" src="{{ asset('back/dist/assets/img/ecommerce/products/9.png') }}" alt="product-img"
                                class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 !ring-transparent">
                            <div>
                                <p class="text-sm font-medium text-gray-800">
                        ...
                        <div class="ti-dropdown-item relative header-box">
                            <a href="cart.html" class="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <img loading="lazy" src="{{ asset('back/dist/assets/img/ecommerce/products/10.png') }}" alt="product-img"
                                class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 !ring-transparent">
                            <div>
                                <p class="text-sm font-medium text-gray-800">
                    ...
                    <div class="ti-dropdown-divider divide-y divide-gray-200">
                        ...
                        <div class="ti-dropdown-item relative header-box">
                            ...
                            <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                <img src="{{ asset('back/dist/assets/img/users/17.jpg') }}" alt="img" class="rounded-sm">
                            </div>
                        ...
                        <div class="ti-dropdown-item relative header-box">
                            ...
                            <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                <img src="{{ asset('back/dist/assets/img/users/2.jpg') }}" alt="img" class="rounded-sm">
                            </div>
                            <div class="relative w-full">
                        ...
                        <div class="ti-dropdown-item relative header-box">
                            <a href="mail-inbox.html" class="flex items-center space-x-3 rtl:space-x-reverse">
                            <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                <img src="{{ asset('back/dist/assets/img/users/21.jpg') }}" alt="img" class="rounded-sm">
                            </div>
                            <div class="relative w-full">
                        ...
                        <div class="ti-dropdown-item relative header-box">
                            <a href="mail-inbox.html" class="flex items-center space-x-3 rtl:space-x-reverse">
                            <div class="ltr:mr-2 rtl:ml-2 avatar rounded-full ring-0">
                                <img src="{{ asset('back/dist/assets/img/users/11.jpg') }}" alt="img" class="rounded-sm">
                            </div>
                            <div class="relative w-full">
                ...
                <div class="header-apps hs-dropdown ti-dropdown hidden md:block" data-hs-dropdown-placement="bottom-right">
                    ...
                    <div class="ti-dropdown-divider divide-y divide-gray-200">
                        ...
                        <a href="mail-inbox.html" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                        ...
                        <a href="chat.html" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                        ...
                        <a href="tasks.html" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                        ...
                        <a href="calendar.html" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                        ...
                        <a href="filemanager.html" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                        ...
                        <a href="contacts.html" class="block pt-0 p-2 text-center rounded-sm hover:bg-gray-50">
                ...
                <div class="header-profile hs-dropdown ti-dropdown" data-hs-dropdown-placement="bottom-right">
                    ...
                    <img class="inline-block rounded-full ring-2 ring-white"
                        src="{{ asset('back/dist/assets/img/users/1.jpg') }}" alt="Image Description">
                    </button>
                    ...
                    <div class="ti-dropdown-header !bg-primary flex">
                        ...
                        <img class="avatar shadow-none rounded-full !ring-transparent"
                            src="{{ asset('back/dist/assets/img/users/1.jpg') }}" alt="profile-img">
                        </div>
                        <div>
                    ...
                    <div class="mt-2 ti-dropdown-divider">
                        <a href="{{ route('user.profile') }}" class="ti-dropdown-item">
