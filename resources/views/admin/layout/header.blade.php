<div class="page-header">
    <div class="header-wrapper row m-0">
      ...
      <div class="header-logo-wrapper col-auto p-0">
        ...
        <div class="logo-header-main"><a href="#"><img class="img-fluid for-light"
        ...
        <ul class="nav-menus">
          ...
          <li class="profile-nav onhover-dropdown">
            ...
            <ul class="profile-dropdown onhover-show-div">
              <li><a href="{{ route('admin.profile.edit', Auth::user()->id) }}"><i data-feather="settings"></i><span>Settings</span></a></li>
              <li>
                <form action="{{ route('admin.logout') }}" method="post">
                  @csrf
                  <a href="#" onclick="this.closest('form').submit()"><i data-feather="log-out"></i><span>Log out</span></a>
                </form>
                <!-- <a href="{{ route('login') }}"><i data-feather="log-out"> </i><span>Log out</span></a></li> -->
            </ul>
          </li>
        </ul>
      </div>
