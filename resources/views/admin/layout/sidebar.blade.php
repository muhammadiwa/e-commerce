      ...
      <nav class="sidebar-main">
        ...
        <div id="sidebar-menu">
          <ul class="sidebar-links" id="simple-bar">
            ...
            <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title link-nav" href="{{ route('admin.dashboard') }}" target="_blank"><i data-feather="anchor"></i><span>Starter kit</span></a></li>
