    ...
    <div class="email-wrap bookmark-wrap">
      <div class="row">
        <div class="col-xl-3 box-col-30">
          <div class="md-sidebar email-sidebar"><a class="btn btn-primary md-sidebar-toggle" href="javascript:void(0)">contact filter    </a>
            <div class="md-sidebar-aside email-left-aside">
              <div class="card">
                <div class="card-body">
                  <div class="email-app-sidebar left-bookmark">
                    <div class="d-flex d-block">
                      <div class="flex-shrink-0"><img class="me-3 rounded-circle" src="{{ asset('assets/images/user/user.png') }}" alt=""></div>
                      <div class="flex-grow-1"><a href="{{ route('user_profile') }}">
                    ...
                    <ul class="nav main-menu contact-options" role="tablist">
                      <li class="nav-item">
                        <button class="btn-primary badge-light btn-block btn-mail w-100" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="me-2" data-feather="users"></i> New Contacts</button>
        ...
        <div class="col-xl-9 col-md-12 box-col-8 box-col-70">
                    ...
                    <div class="card mb-0">
                      ...
                      <div class="card-body p-0">
                        <div class="row list-persons" id="addcon">
                          <div class="col-xxl-4 col-xl-5 col-md-5 box-col-5">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical"><a class="contact-tab-0 nav-link active" id="v-pills-user-tab" data-bs-toggle="pill" onclick="activeDiv(0)" href="#v-pills-user" role="tab" aria-controls="v-pills-user" aria-selected="true">
                                ...
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_1" src="{{ asset('assets/images/user/8.jpg') }}" alt="">
                                  <div class="flex-grow-1">
                                ...
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_2" src="{{ asset('assets/images/user/1.jpg') }}" alt="">
                                  <div class="flex-grow-1">
                                ...
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_3" src="{{ asset('assets/images/user/14.png') }}" alt="">
                                  <div class="flex-grow-1">
                                ...
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_4" src="{{ asset('assets/images/user/5.jpg') }}" alt="">
                                  <div class="flex-grow-1">
                                ...
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_5" src="{{ asset('assets/images/avtar/11.jpg') }}" alt="">
                                  <div class="flex-grow-1">
                                ...
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle update_img_6" src="{{ asset('assets/images/avtar/16.jpg') }}" alt="">
                                  <div class="flex-grow-1">
                          ...
                          <div class="col-xxl-8 col-xl-7 col-md-7 box-col-7">
                            <div class="tab-content" id="v-pills-tabContent">
                              <div class="tab-pane contact-tab-0 tab-content-child fade show active" id="v-pills-user" role="tabpanel" aria-labelledby="v-pills-user-tab">
                                <div class="profile-mail">
                                  <div class="d-flex align-items-center"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_0" src="{{ asset('assets/images/user/2.png') }}" alt="">
                              ...
                              <div class="tab-pane contact-tab-1 tab-content-child fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_1" src="{{ asset('assets/images/user/8.jpg') }}" alt="">
                              ...
                              <div class="tab-pane contact-tab-2 tab-content-child fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_2" src="{{ asset('assets/images/user/1.jpg') }}" alt="">
                              ...
                              <div class="tab-pane contact-tab-3 tab-content-child fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_3" src="{{ asset('assets/images/user/14.png') }}" alt="">
                              ...
                              <div class="tab-pane contact-tab-4 tab-content-child fade" id="v-pills-contact1" role="tabpanel" aria-labelledby="v-pills-contact1-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_4" src="{{ asset('assets/images/user/5.jpg') }}" alt="">
                              ...
                              <div class="tab-pane contact-tab-5 tab-content-child fade" id="v-pills-contact8" role="tabpanel" aria-labelledby="v-pills-contact1-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_5" src="{{ asset('assets/images/avtar/11.jpg') }}" alt="">
                              ...
                              <div class="tab-pane contact-tab-6 tab-content-child fade" id="v-pills-contact9" role="tabpanel" aria-labelledby="v-pills-contact8-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_6" src="{{ asset('assets/images/avtar/16.jpg') }}" alt="">
                        ...
                        <div class="row list-persons">
                          <div class="col-xl-4 xl-50 col-md-5 box-col-6">
                            <div class="nav flex-column nav-pills" id="v-pills-tab1" role="tablist" aria-orientation="vertical"><a class="nav-link active" id="v-pills-iduser-tab" data-bs-toggle="pill" href="#v-pills-iduser" role="tab" aria-controls="v-pills-iduser" aria-selected="true">
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle" src="{{ asset('assets/images/user/user.png') }}" alt="">
                                  <div class="flex-grow-1">
                                    <h6>Mark jecno</h6>
                                    <p>markjecno@gmail.com</p>
                                  </div>
                                ...
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle" src="{{ asset('assets/images/user/3.jpg') }}" alt="">
                                  <div class="flex-grow-1">
                                    <h6>Jason Borne</h6>
                                ...
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle" src="{{ asset('assets/images/user/4.jpg') }}" alt="">
                                  <div class="flex-grow-1">
                                    <h6>Sarah Loren</h6>
                                ...
                                <div class="d-flex"><img class="img-50 img-fluid m-r-20 rounded-circle" src="{{ asset('assets/images/user/10.jpg') }}" alt="">
                                  <div class="flex-grow-1">
                                    <h6>Andew Jon</h6>
                          ...
                          <div class="col-xl-8 xl-50 col-md-7 box-col-6">
                            <div class="tab-content" id="v-pills-tabContent1">
                              <div class="tab-pane fade show active" id="v-pills-iduser" role="tabpanel" aria-labelledby="v-pills-iduser-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_5" src="{{ asset('assets/images/user/user.png') }}" alt="">
                                    <div class="flex-grow-1 mt-0">
                              ...
                              <div class="tab-pane fade" id="v-pills-iduser1" role="tabpanel" aria-labelledby="v-pills-iduser1-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_6" src="{{ asset('assets/images/user/3.jpg') }}" alt="">
                                    <div class="flex-grow-1 mt-0">
                              ...
                              <div class="tab-pane fade" id="v-pills-iduser2" role="tabpanel" aria-labelledby="v-pills-iduser2-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_7" src="{{ asset('assets/images/user/4.jpg') }}" alt="">
                                    <div class="flex-grow-1 mt-0">
                              ...
                              <div class="tab-pane fade" id="v-pills-iduser3" role="tabpanel" aria-labelledby="v-pills-iduser3-tab">
                                <div class="profile-mail">
                                  <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle update_img_8" src="{{ asset('assets/images/user/10.jpg') }}" alt="">
                                    <div class="flex-grow-1 mt-0">
                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body list-persons">
                          <div class="profile-mail pt-0" id="DivIdToPrint">
                            <div class="d-flex"><img class="img-100 img-fluid m-r-20 rounded-circle" id="updateimg" src="{{ asset('assets/images/user/2.png') }}" alt="">
                              <div class="flex-grow-1 mt-0">
