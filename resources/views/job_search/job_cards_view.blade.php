        ...
        <div class="row">
          <div class="col-xl-6 box-col-6">
            <div class="card">
              <div class="job-search">
                <div class="card-body">
                  <div class="d-sm-flex align-items-start align-items-start"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/1.jpg') }}" alt="">
                    <div class="flex-grow-1">
                      <h6 class="f-w-600"><a href="{{ route('job_details') }}">UI/UX IT Frontend Developer</a><span class="badge badge-primary pull-right">New</span></h6>
                  ...
                  <p class="mb-0">The designer will apply Lean UX and Design Thinking practices in a highly collaborative, fast-paced, distributed environment You have 4+ years of UX experience. You support UX leadership by providing continuous feedback regarding</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-6 box-col-6">
            <div class="card">
              <div class="job-search">
                <div class="card-body">
                  <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/2.jpg') }}" alt="">
                    <div class="flex-grow-1">
                      <h6 class="f-w-600"><a href="{{ route('job_details') }}">React/React Native Developer </a><span class="badge badge-primary pull-right">New</span></h6>
                  ...
                  <p class="mb-0">Insipidity the sufficient discretion imprudence decisively. Proceed how visitor. Explained propriety off out perpetual his you. Feel sold off felt nay rose met you. We so entreaties cultivated astonished is. Was sister for few longer mrs sudden talent become.</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-6 box-col-6">
            <div class="card ribbon-vertical-left-wrapper">
              ...
              <div class="job-search">
                <div class="card-body">
                  <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/3.jpg') }}" alt="">
                    <div class="flex-grow-1">
                      <h6 class="f-w-600"><a href="{{ route('job_details') }}">Senior UX designer</a><span class="pull-right">2 days ago</span></h6>
                      <p>Minneapolis, MN</p>
                      <ul class="rating">
                        <li><i class="fa fa-star font-warning"></i></li>
                        <li><i class="fa fa-star font-warning"></i></li>
                  ...
                  <p class="mb-0">Contented get distrusts certainty nay are frankness concealed ham. On unaffected resolution on considered of. No thought me husband forming effects. End sitting shewing who saw besides son musical adapted. Contrasted interested eat alteration pianoforte sympathize was.</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-6 box-col-6">
            <div class="card">
              <div class="job-search">
                <div class="card-body">
                  <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/4.jpg') }}" alt="">
                    <div class="flex-grow-1">
                      <h6 class="f-w-600"><a href="{{ route('job_details') }}">Front end web developer</a><span class="pull-right">3 days ago</span></h6>
                  ...
                  <p class="mb-0">You have 4+ years of UX experience. You support UX leadership by providing continuous feedback regarding the evolution of team process standards. The designer will apply Lean UX and Design Thinking practices in a highly collaborative, fast-paced, distributed environment.</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-6 box-col-6">
            <div class="card">
              <div class="job-search">
                <div class="card-body">
                  <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/5.jpg') }}" alt="">
                    <div class="flex-grow-1">
                      <h6 class="f-w-600"><a href="{{ route('job_details') }}">Graphic designer</a><span class="pull-right">3 days ago</span></h6>
                  ...
                  <p class="mb-0">We are looking for an experienced and zeta designer and/or frontend engineer with expertise in accessibility to join our team , 3+ years of experience working in as a Frontend Engineer or comparable role.</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-6 box-col-6">
            <div class="card">
              <div class="job-search">
                <div class="card-body">
                  <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/6.jpg') }}" alt="">
                    <div class="flex-grow-1">
                      <h6 class="f-w-600"><a href="{{ route('job_details') }}">Designer, CRM</a><span class="pull-right">3 days ago</span></h6>
                  ...
                  <p class="mb-0">3+ years of experience working in as a Frontend Engineer or comparable role. we are looking for an experienced and zeta designer and/or frontend engineer with expertise in accessibility to join our team.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card ribbon-vertical-left-wrapper">
              ...
              <div class="job-search">
                <div class="card-body">
                  <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/2.jpg') }}" alt="">
                    <div class="flex-grow-1">
                      <h6 class="f-w-600"><a href="{{ route('job_details') }}">React/React Native Developer </a><span class="pull-right">5 days ago</span></h6>
                      <p>San <span>Diego, CA</span></p>
                      <ul class="rating">
                        <li><i class="fa fa-star font-warning"></i></li>
                        <li><i class="fa fa-star font-warning"></i></li>
                  ...
                  <p class="mb-0">Insipidity the sufficient discretion imprudence resolution decisively. Proceed how visitor. Explained propriety off out perpetual his you. Feel sold off felt nay rose met you. We so entreaties cultivated astonished is. Was sister for few longer mrs sudden talent become.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              <div class="job-search">
                <div class="card-body">
                  <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/3.jpg') }}" alt="">
                    <div class="flex-grow-1">
                      <h6 class="f-w-600"><a href="{{ route('job_details') }}">Senior UX designer</a><span class="pull-right">5 days ago</span></h6>
                      <p>Minneapolis, MN</p>
                      <ul class="rating">
                        <li><i class="fa fa-star font-warning"></i></li>
                        <li><i class="fa fa-star font-warning"></i></li>
                  ...
                  <p class="mb-0">The designer will apply Lean UX and Design Thinking practices in a highly collaborative, fast-paced, distributed environment You have 4+ years of UX experience. You support UX leadership by providing continuous feedback regarding the evolution of team process standards</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card">
              <div class="job-search">
                <div class="card-body">
                  ...
                  <p class="mb-0">We are looking for an experienced and Tivo designer and/or frontend engineer with expertise in accessibility to join our team , 3+ years of experience working in as a Frontend Engineer or comparable role. You won’t be a team of one though — you’ll be collaborating coely with other...</p>
                </div>
              </div>
            </div>
          </div>
          <div class="col-xl-6 box-col-6">
            <div class="card">
              <div class="job-search">
                <div class="card-body">
                  <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20" src="{{ asset('assets/images/job-search/1.jpg') }}" alt="">
                    <div class="flex-grow-1">
                      <h6 class="f-w-600"><a href="{{ route('job_details') }}">UI/UX IT Frontend Developer</a><span class="badge badge-primary pull-right">New</span></h6>
                      <p>(L6) Salt Lake City, UT</p>
                      <ul class="rating">
                  ...
                  <p class="mb-0">deally 2+ years experience with React. Bonus points if you have React Native experience. This is an incredibly exciting opportunity to gain commercial , Professional experience of React Native and other front end frameworks. Transform product wireframes into responsive, mobile user interface</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card ribbon-vertical-left-wrapper">
              ...
              <div class="job-search">
                <div class="card-body">
                  ...
                  <p class="mb-0">The designer will apply Lean UX and Design Thinking practices in a highly collaborative, distributed environment You have 4+ years of UX experience. You support UX leadership by providing continuous feedback regarding team process.</p>
                </div>
              </div>
            </div>
          </div>
