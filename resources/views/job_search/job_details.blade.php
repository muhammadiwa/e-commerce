                                            ...
                                            <div class="card-body animate-chk">
                                                ...
                                                <label class="d-block" for="chk-ani12">
                                                    <input class="checkbox_animated" id="chk-ani12"
                                                        type="checkbox">Graphic designer(10)
                                                </label>
                                            ...
                                            <div class="card-body animate-chk">
                                                <label class="d-block" for="chk-ani16">
                                                    <input class="checkbox_animated" id="chk-ani16"
                                                        type="checkbox">Computer Software(14)
                                                </label>
                                            ...
                                            <div class="card-body animate-chk">
                                                <label class="d-block" for="chk-ani21">
                                                    <input class="checkbox_animated" id="chk-ani21"
                                                        type="checkbox">HTML,scss & sass
                                                </label>
                                                <label class="d-block" for="chk-ani23">
                                                    <input class="checkbox_animated" id="chk-ani23"
                                                        type="checkbox">Javascript
                                                </label>
                                                <label class="d-block" for="chk-ani24">
                                                    <input class="checkbox_animated" id="chk-ani24"
                                                        type="checkbox">Node.js
                                                </label>
                                                ...
                                                <label class="d-block mb-0" for="chk-ani26">
                                                    <input class="checkbox_animated" id="chk-ani26"
                                                        type="checkbox">Angular.js
                                                </label>
                                            </div>
                                            <button class="btn btn-block btn-primary text-center" type="button">All
                                                Skills</button>
            ...
            <div class="col-xxl-9 col-xl-8 box-col-8">
                <div class="card">
                    <div class="job-search">
                        <div class="card-body">
                            <div class="d-sm-flex align-items-start align-items-start"><img class="img-40 img-fluid m-r-20"
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="f-w-700"><a href="{{ route('job_details') }}">React/React Native
                                    ...
                                    <p class="mb-0">This is an incredibly exciting opportunity to gain commercial , Professional experience of React Native. Transform product wireframes into responsive, mobile user interface components and Ideally 2+ years experience with React. Bonus points if you have React Native experience.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="f-w-700"><a href="{{ route('job_details') }}">Front end web
                                    ...
                                    <p class="mb-0">Professional experience of React Native and other front end frameworks. Transform product wireframes into responsive, mobile user interface components and Bonus points if you have React Native experience. This is an incredibly exciting opportunity to gain commercial.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="f-w-700"><a href="{{ route('job_details') }}">Graphic designer</a><span
                                    ...
                                    <p class="mb-0">Transform product wireframes into responsive, mobile user interface components and Ideally 2+ years experience with React. Bonus points if you have React Native experience. Professional experience of React Native and other front end frameworks.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="f-w-700"><a href="{{ route('job_details') }}">Designer, CRM</a><span
                                                    class="pull-right">3 days ago</span></h6>
                                    ...
                                    <p class="mb-0">Bonus points if you have React Native experience. This is an incredibly exciting opportunity. Professional experience of React Native frameworks. Transform product wireframes into responsive, mobile user interface components and Ideally 2+ years experience with React.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="job-search">
                                <div class="card-body">
                                    <div class="d-sm-flex align-items-start"><img class="img-40 img-fluid m-r-20"
                                        ...
                                        <div class="flex-grow-1">
                                            <h6 class="f-w-700"><a href="{{ route('job_details') }}">Senior UX designer</a><span
                                    ...
                                    <p class="mb-0">Woody equal ask saw sir weeks aware decay. Entrance prospect removing we packages strictly is no smallest he. For hopes may chief get hours day rooms. Oh no turned behind polite piqued enough at. Forbade few through inquiry blushes you. Cousin no itself eldest it in dinner latter missed no.</p>
                                </div>
                            </div>
                        </div>
                    </div>
