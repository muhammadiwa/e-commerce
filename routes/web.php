...
Route::group(['middleware' => ['auth', 'verified'], 'prefix' => 'user', 'as' => 'user.'], function () {
    ...
    Route::post('profile/update-photo/{id}', [UserProfileController::class, 'updatePhoto'])->name('profile.updatePhoto');
    Route::post('profile/update-password/{id}', [UserProfileController::class, 'updatePassword'])->name('profile.updatePassword');
